...
def heal_units(val_list):
    ...
    for thing in controllables:
        if type(thing) == Units.Unit and thing not in val_list[2] and thing.HP > 0:
...
predefined_structures = {   
    ...
    "Barricade" :       [14, 14, 0, 2, False, 2, False, (12, 1), 60/100, None, (None, None)],
    "Bunker" :          [25, 25, 0, 2, True, 3, False, (20, 2), 35/100, None, (None, None)],
    "Cache" :           [15, 15, 0, 0, False, 3, False, (10, 0), 70/100, None, (None, None)],
    "Healing_Point" :   [15, 15, 5, 1, False, 3, False, (35, 5), 30/100, "heal_units", (None, None)],
    "Node" :            [6, 6, 0, 0, False, 2, False, (3, 0), 75/100, None, (None, None)],
    "Radar" :           [7, 7, 0, 0, False, 11, True, (20, 3), 20/100, None, (None, None)],
